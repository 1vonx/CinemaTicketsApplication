...
using CinemaTicketsApp.Repository.Implementation;
using CinemaTicketsApp.Repository.Interface;
using CinemaTicketsApp.Service;
using CinemaTicketsApp.Service.Implementation;
...
namespace CinemaTicketsApp.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<CinemaTicketsAppUser, IdentityRole>()
